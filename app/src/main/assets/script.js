...
// showSolutionRootButt.onclick = function () {
//     firstAnswText.style.opacity = "1";
// }
// showSolutionRootButt.addEventListener("touchend", () => {
//     firstAnswText.style.opacity = "1";
// });
// function showSoltRootFunc () {
//     firstAnswText.style.opacity = "1";
// };
// showSolutionRootButt.addEventListener("touchstart", showSoltRootFunc);
// document.addEventListener("DOMContentLoaded", showSoltRootFunc);
